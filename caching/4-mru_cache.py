...
class MRUCache(BaseCaching):
    """A caching system that removes items using an MRU policy."""
    ...
    def put(self, key, item):
        """Add an item to the cache, evicting the MRU item if needed.
        ...
        the key that was most recently used just before this put is
        discarded, and a message "DISCARD: <key>" is printed.
        """
